...
m=21; n=21; % includes boundary nodes, mesh spacing 1/(m-1) and 1/(n-1)
...
for e=1:T  % integration over one triangular element at a time
  ...
  Fe=0*Area/3; % integral of phi over triangle is volume of pyramid: f(x,y)=1
...
K(b,:)=0; K(:,b)=0; F(b)=1; % put zeros in boundary rows/columns of K and F 
